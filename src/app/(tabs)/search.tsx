...
import { searchBible, type SearchHit } from "@/lib/search";
...
export default function SearchScreen() {
  ...
  useEffect(() => {
    ...
    setSearching(true);
    const t = setTimeout(() => {
      void searchBible(q, LIMIT).then((hits) => {
        setResults(hits);
        setSearching(false);
        setTouched(true);
      });
  ...
  // Semantic results (on-device embedding search; native only).
  useEffect(() => {
    ...
    <View style={styles.root}>
      <View style={[styles.bar, { paddingTop: insets.top + 10 }]}>
        <View style={styles.inputWrap}>
          ...
          <TextInput
            ...
            placeholder="Search the whole Bible"
      ...
      {searching ? (
        ...
        <FlatList
          ...
          ListHeaderComponent={
            <Text style={styles.count}>
              {results.length > 0 ? countLine : "No exact word matches"}
            </Text>
          }
        ...
        <View style={styles.empty}>
          {touched ? (
            <>
              <Text style={styles.emptyTitle}>No verses match “{query.trim()}”</Text>
            ...
            <>
              <Text style={styles.emptyTitle}>Search all 31,102 verses</Text>
              <Text style={styles.emptySub}>
