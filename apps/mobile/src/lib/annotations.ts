...
const K_HIGHLIGHTS = "openscripture.highlights";
const K_BOOKMARKS = "openscripture.bookmarks";
const K_NOTES = "openscripture.notes";
const K_POSITION = "openscripture.position";
